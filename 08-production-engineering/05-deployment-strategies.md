...
Imagine you have to replace every lane of a busy highway with fresh pavement — but you are not allowed to close the highway. You cannot dynamite all four lanes and pour new concrete; cars are on them. So you do one lane at a time: close lane 1, repave it, reopen it, move to lane 2. While you work, cars flow on the other lanes. Crucially, for the whole duration, **old lanes and new lanes carry traffic simultaneously**, and a car must be able to drive from an old lane straight onto a new one without falling into a pothole at the seam. The new pavement has to be *compatible* with the old at every boundary.
