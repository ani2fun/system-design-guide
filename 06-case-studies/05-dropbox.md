...
A **runnable implementation** lives at `_proof-of-concepts/06-case-studies/05-dropbox/` in the repo root — the sync agent (`Chunker`, `ManifestDiffer`, `SyncEngine`, mirroring the code view) against a FastAPI file service backed by a content-addressed chunk store in Postgres.

```bash
cd _proof-of-concepts/06-case-studies/05-dropbox
...
**Run it yourself.** [Dropbox — content-addressed sync](https://github.com/ani2fun/system-design-guide/tree/main/_proof-of-concepts/06-case-studies/05-dropbox)
...
`_proof-of-concepts/06-case-studies/05-dropbox/`, run `./run`.
