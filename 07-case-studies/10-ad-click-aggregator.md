...
**Run it yourself.** [Ad-click aggregator](https://github.com/ani2fun/system-design-guide/tree/main/_proof-of-concepts/07-case-studies/10-ad-click-aggregator)
...
`_proof-of-concepts/07-case-studies/10-ad-click-aggregator/`, run `./run`.
