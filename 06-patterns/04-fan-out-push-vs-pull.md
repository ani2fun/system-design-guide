...
- [Our News Feed POC](https://github.com/ani2fun/system-design-guide/tree/main/_proof-of-concepts/07-case-studies/03-news-feed)
  — the case study's hybrid fan-out implemented end to end (push for normal users, pull for
  celebrities); from `_proof-of-concepts/07-case-studies/03-news-feed/`, `./run`.
